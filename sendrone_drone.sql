...
CREATE TABLE `drone` (
  ...
  PRIMARY KEY (`idDrone`),
  KEY `fk_Drone_Producto1_idx` (`Producto_idProducto`),
  KEY `fk_Drone_Pedido1_idx` (`Pedido_idPedido`),
  CONSTRAINT `fk_Drone_Pedido1` FOREIGN KEY (`Pedido_idPedido`) REFERENCES `pedido` (`idpedido`),
  CONSTRAINT `fk_Drone_Producto1` FOREIGN KEY (`Producto_idProducto`) REFERENCES `producto` (`idproducto`)
